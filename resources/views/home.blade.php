...
<head>
    <meta charset="utf-8" />
    <title>SGT | Sistema Generador de Tickets</title>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="http://127.0.0.1:8000/images/avatar-1.jpg"
                                alt="Header Avatar">
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{route('medicos.index')}}" class="nav-link">Medicos</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('consultorios.index')}}" class="nav-link">Consultorios</a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('horasAtenciones.index')}}" class="nav-link">Horas de Atencion</a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="menu-title"><i class="ri-more-fill"></i> <span>Atenciones y Tickets</span></li>
                        ...
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarSignIn">
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="{{route('atenciones.index')}}" class="nav-link">Atenciones</a>
                                        </li>
                                        <li class="nav-item">
...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Sistema Generador de Tickets</h4>
